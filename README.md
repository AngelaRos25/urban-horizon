...
Before the authentication, you have to click link and login in GoRest application and copy the generated token. After having authenticated, you have Home section where you can see the list of users, with the possibility of searching user. It possible to create or delete a user.
